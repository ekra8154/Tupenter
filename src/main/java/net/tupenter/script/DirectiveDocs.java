    ...
    private static List<Doc> buildAll() {
        return List.of(
                ...
                doc("set", Group.VARIABLES, "#set $name$ = value",
                        ...
                        "§7Compound forms:§r #set x += 1 (also -= *= /= %=) · the $ around the name is optional · dotted groups organize: #set hitlist.bob = \"wanted\".",
                        "§7The right side is expression world§r — #set x = x + 1 works bare; quotes make text values.",
                ...
                doc("setdefault", Group.VARIABLES, "#setdefault $name$ = value",
                        ...
                        "§7The stateful-command idiom:§r the composed example is a complete freeze TOGGLE that's safe to paste into any world — first run initializes, every run flips.",
