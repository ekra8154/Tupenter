...
public record EvalContext(Random random, VariableProvider variables, TagResolver tags, BlockReader blocks,
    ...
    public EvalContext(Random random) {
        this(random, VariableProvider.EMPTY, TagResolver.NONE, BlockReader.NONE, FunctionResolver.NONE, Raycaster.NONE);
    }

    public EvalContext(Random random, VariableProvider variables) {
        this(random, variables, TagResolver.NONE, BlockReader.NONE, FunctionResolver.NONE, Raycaster.NONE);
    }

    public EvalContext(Random random, VariableProvider variables, TagResolver tags) {
        this(random, variables, tags, BlockReader.NONE, FunctionResolver.NONE, Raycaster.NONE);
    }

    public EvalContext(Random random, VariableProvider variables, TagResolver tags, BlockReader blocks) {
        this(random, variables, tags, blocks, FunctionResolver.NONE, Raycaster.NONE);
    }

    public EvalContext(Random random, VariableProvider variables, TagResolver tags, BlockReader blocks,
                       FunctionResolver functions) {
        this(random, variables, tags, blocks, functions, Raycaster.NONE);
    }
}
